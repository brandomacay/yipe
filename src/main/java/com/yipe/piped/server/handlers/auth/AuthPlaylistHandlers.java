package com.yipe.piped.server.handlers.auth;
...
import com.yipe.piped.utils.obj.db.Playlist;
import it.unimi.dsi.fastutil.objects.Object2ObjectOpenHashMap;
import it.unimi.dsi.fastutil.objects.ObjectArrayList;
import it.unimi.dsi.fastutil.objects.ObjectOpenHashSet;
import com.yipe.piped.consts.Constants;
import com.yipe.piped.utils.obj.ContentItem;
import com.yipe.piped.utils.obj.StreamItem;
import com.yipe.piped.utils.obj.db.Channel;
import com.yipe.piped.utils.obj.db.PlaylistVideo;
import com.yipe.piped.utils.obj.db.User;
import com.yipe.piped.utils.resp.AcceptedResponse;
import com.yipe.piped.utils.resp.AuthenticationFailureResponse;
...
import static com.yipe.piped.utils.URLUtils.rewriteURL;
import static com.yipe.piped.utils.URLUtils.substringYouTube;
...
public class AuthPlaylistHandlers {
    public static byte[] playlistPipedResponse(String playlistId) throws Exception {
        ...
        try (Session s = DatabaseSessionFactory.createSession()) {
            ...
            final com.yipe.piped.utils.obj.Playlist playlist = new com.yipe.piped.utils.obj.Playlist(pl.getName(), rewriteURL(pl.getThumbnail()), pl.getShortDescription(), null, null, pl.getOwner().getUsername(),
    ...
    public static byte[] createPlaylist(String session, String name) throws IOException {
        ...
        try (Session s = DatabaseSessionFactory.createSession()) {
            var playlist = new Playlist(name, user, "https://i.ytimg.com/");
    ...
    public static byte[] addToPlaylistResponse(String session, String playlistId, List<String> videoIds) throws IOException, ExtractionException {
        ...
        try (Session s = DatabaseSessionFactory.createSession()) {
            ...
            var query = cb.createQuery(Playlist.class);
            var root = query.from(Playlist.class);
            ...
            for (String videoId : videoIds) {
                ...
                if (video == null) {
                    try {
                        ...
                        video = new PlaylistVideo(videoId, info.getName(), info.getThumbnails().get(info.getThumbnails().size()-1).getUrl(), info.getDuration(), channel);
    ...
    public static byte[] importPlaylistResponse(String session, String playlistId) throws IOException, ExtractionException {
        ...
        var playlist = new Playlist(info.getName(), user, info.getThumbnails().get(info.getThumbnails().size()-1).getUrl());
        ...
        try (Session s = DatabaseSessionFactory.createSession()) {
            ...
            videos.forEach(video -> {
                ...
                playlist.getVideos().add(videoMap.computeIfAbsent(videoId, (key) -> new PlaylistVideo(videoId, video.getName(), video.getThumbnails().get(info.getThumbnails().size()-1).getUrl(), video.getDuration(), channel)));
            });
