...
import com.yipe.piped.utils.obj.SubscriptionChannel;
import com.yipe.piped.utils.obj.db.Channel;
import com.yipe.piped.utils.obj.db.UnauthenticatedSubscription;
import com.yipe.piped.utils.obj.db.User;
import com.yipe.piped.utils.obj.db.Video;
...
import com.yipe.piped.utils.resp.SubscribeStatusResponse;
        ...
        try (StatelessSession s = DatabaseSessionFactory.createStatelessSession()) {
            ...
            if (filteredChannels.size() == 1) {
                if (!videos.isEmpty()) {
                    ...
                    ChannelHelpers.updateChannel(s, channel, StringUtils.abbreviate(info.getName(), 100), info.getAvatars().isEmpty() ? null : info.getAvatars().get(info.getAvatars().size()-1).getUrl(), info.isVerified());
