...
import com.yipe.piped.utils.obj.*;
import io.sentry.Sentry;
import com.yipe.piped.consts.Constants;
import com.yipe.piped.utils.obj.db.Video;
import com.yipe.piped.utils.obj.federation.FederatedChannelInfo;
import com.yipe.piped.utils.obj.federation.FederatedVideoInfo;
...
import static com.yipe.piped.utils.CollectionUtils.collectPreloadedTabs;
import static com.yipe.piped.utils.CollectionUtils.collectRelatedItems;
import static com.yipe.piped.utils.URLUtils.getLastThumbnail;
        ...
        Multithreading.runAsync(() -> {
            try {
                MatrixHelper.sendEvent("video.piped.channel.info", new FederatedChannelInfo(
                        info.getId(), StringUtils.abbreviate(info.getName(), 100), info.getAvatars().isEmpty() ? null : info.getAvatars().get(info.getAvatars().size()-1).getUrl(), info.isVerified())
                );
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
